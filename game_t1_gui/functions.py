...
def tf_start(point,start_btn,box_size,mx,my,change_click,click):
    ...
    if 289 <= mx <= 289+355 and 261 <= my <= 261+52: # Play
        start_btn = pygame.image.load('./Game_Assets/Intro_Page/Start_Button_Hover.png')
        start_btn = pygame.transform.scale(start_btn,box_size)
        point = 1
        if change_click:
            start_btn = pygame.image.load('./Game_Assets/Intro_Page/Start_Button_Clicked.png')
            start_btn = pygame.transform.scale(start_btn,box_size)
        elif click:
            dest_start = True
    else:
...
def tf_save(point,saved_btn,box_size,mx,my,change_click,click):
    ...
    if 289 <= mx <= 289+355 and 338 <= my <= 338+52: # Save / Load
        saved_btn = pygame.image.load('./Game_Assets/Intro_Page/Saved_Files_Hover.png')
        saved_btn = pygame.transform.scale(saved_btn,box_size)
        point = 2
        if change_click:
            saved_btn = pygame.image.load('./Game_Assets/Intro_Page/Saved_Files_Clicked.png')
            saved_btn = pygame.transform.scale(saved_btn,box_size)
        elif click:
            dest_saved = True
    else:
...
def tf_quit(point,quit_btn,box_size,mx,my,change_click,click):
    ...
    if 289 <= mx <= 289+355 and 417 <= my <= 417+52: # Quit
        quit_btn = pygame.image.load('./Game_Assets/Intro_Page/Exit_Button_Hover.png')
        quit_btn = pygame.transform.scale(quit_btn,box_size)
        point = 3
        if change_click:
            quit_btn = pygame.image.load('./Game_Assets/Intro_Page/Exit_Button_Clicked.png')
            quit_btn = pygame.transform.scale(quit_btn,box_size)
        elif click:
            dest_quit = True
    else:
...
def tf_pvp(point,pvp_btn,box_size,mx,my,change_click,click):
    ...
    if 40 <= mx <= 40+400 and 140 <= my <= 140+400:
        pvp_btn = pygame.image.load('./Game_Assets/Player_vs_AI/Player_vs_Player_Hover.png')
        pvp_btn = pygame.transform.scale(pvp_btn,box_size)
        if change_click:
            pvp_btn = pygame.image.load('./Game_Assets/Player_vs_AI/Player_vs_Player_Clicked.png')
            pvp_btn = pygame.transform.scale(pvp_btn,box_size)
        elif click:
            dest_pvp = True
    else:
...
def tf_pvai(point,pvai_btn,box_size,mx,my,change_click,click):
    ...
    if 460 <= mx <= 460+400 and 140 <= my <= 140+400:
        pvai_btn = pygame.image.load('./Game_Assets/Player_vs_AI/Player_vs_AI_Hover.png')
        pvai_btn = pygame.transform.scale(pvai_btn,box_size)
        if change_click:
            pvai_btn = pygame.image.load('./Game_Assets/Player_vs_AI/Player_vs_AI_Clicked.png')
            pvai_btn = pygame.transform.scale(pvai_btn,box_size)
        elif click:
            dest_pvai = True
    else:
...
def tf_one(point,one_btn,box_size,mx,my,change_click,click):
    ...
    if 61 <= mx <= 61+252 and 130 <= my <= 130+210:
        one_btn = pygame.image.load('./Game_Assets/Team_Size/1v1_Hover.png')
        one_btn = pygame.transform.scale(one_btn,box_size)
        if change_click:
            one_btn = pygame.image.load('./Game_Assets/Team_Size/1v1_Clicked.png')
            one_btn = pygame.transform.scale(one_btn,box_size)
        elif click:
            dest_one = True
    else:
...
def tf_two(point,two_btn,box_size,mx,my,change_click,click):
    ...
    if 325 <= mx <= 325+252 and 130 <= my <= 130+210:
        two_btn = pygame.image.load('./Game_Assets/Team_Size/2v2_Hover.png')
        two_btn = pygame.transform.scale(two_btn,box_size)
        if change_click:
            two_btn = pygame.image.load('./Game_Assets/Team_Size/2v2_Clicked.png')
            two_btn = pygame.transform.scale(two_btn,box_size)
        elif click:
            dest_two = True
    else:
...
def tf_three(point,three_btn,box_size,mx,my,change_click,click):
    ...
    if 589 <= mx <= 589+252 and 130 <= my <= 130+210:
        three_btn = pygame.image.load('./Game_Assets/Team_Size/3v3_Hover.png')
        three_btn = pygame.transform.scale(three_btn,box_size)
        if change_click:
            three_btn = pygame.image.load('./Game_Assets/Team_Size/3v3_Clicked.png')
            three_btn = pygame.transform.scale(three_btn,box_size)
        elif click:
            dest_three = True
    else:
...
def tf_four(point,four_btn,box_size,mx,my,change_click,click):
    ...
    if 107 <= mx <= 107+329 and 346 <= my <= 346+240:
        four_btn = pygame.image.load('./Game_Assets/Team_Size/4v4_Hover.png')
        four_btn = pygame.transform.scale(four_btn,box_size)
        if change_click:
            four_btn = pygame.image.load('./Game_Assets/Team_Size/4v4_Clicked.png')
            four_btn = pygame.transform.scale(four_btn,box_size)
        elif click:
            dest_four = True
    else:
...
def tf_five(point,five_btn,box_size,mx,my,change_click,click):
    ...
    if 470 <= mx <= 470+329 and 346 <= my <= 346+240:
        five_btn = pygame.image.load('./Game_Assets/Team_Size/5v5_Hover.png')
        five_btn = pygame.transform.scale(five_btn,box_size)
        if change_click:
            five_btn = pygame.image.load('./Game_Assets/Team_Size/5v5_Clicked.png')
            five_btn = pygame.transform.scale(five_btn,box_size)
        elif click:
            dest_five = True
    else:
